...
document.querySelector('#js-totalExp').value = getTotalExp(document.querySelector('#js-currentLevel').value);
}
function printFromToExp(){
document.querySelector('#js-requiredExp').value = getFromToExp(document.querySelector('#js-fromLevel').value, document.querySelector('#js-toLevel').value)
}